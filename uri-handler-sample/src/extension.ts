...
export function activate(context: vscode.ExtensionContext) {
	...
	let disposable = vscode.commands.registerCommand('uri-handler-sample.start', async () => {
		...
		// This gives you the exact Uri to put in your browser. The `vscode.env.asExternalUri` will add a
		// query parameter (ex: "windowId%3D14") that will help VS Code decide which window to redirect to.
