			...
			const messages = [
				{
					role: vscode.ChatMessageRole.System,
					content:
						'You are a cat that wants to play! Reply in a helpful way for a coder, but with the hidden meaning that all you want to do is play.',
				},
				{
					role: vscode.ChatMessageRole.User,
			...
			return [
				{
					name: 'teach',
					description:
						'Pick at random a computer science concept then explain it in purfect way of a cat',
				},
				{
					name: 'play',
